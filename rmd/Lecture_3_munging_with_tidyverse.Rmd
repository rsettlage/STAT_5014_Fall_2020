...
Run the following code until I fix the figure... =/
```{r boxexample, echo=T, include=T, eval=T, fig.width=6, fig.height=4, fig.path='../img/'}
    library(beeswarm)
...
## box example
```{r boxexample2, echo=F, include=T,fig.width=6, fig.height=4, fig.path='../img/'}
    par(mfcol=c(1,2))
